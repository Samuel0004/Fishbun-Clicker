...
public class JellyMove : MonoBehaviour
{
    ...
    public void InstantiateJelly(int page, int lv,float experience, Vector3 point)
    {
        id = page;
        level = lv;
        exp = experience;
    ...
    {
        doDrag = false; //no longer drag jelly
        state = State.Idle; //jelly should return back to idle
